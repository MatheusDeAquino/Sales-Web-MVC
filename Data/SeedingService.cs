...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Billie Eilish", "billie@gmail.com", new DateTime(1995, 5, 30), 1000.00, d1);
            Seller s2 = new Seller(2, "Lil Peep", "peep@gmail.com", new DateTime(1995, 6, 21), 3500.00, d2);
            Seller s3 = new Seller(3, "xxxTentation", "xxxtent@gmail.com", new DateTime(1995, 11, 15), 2200.00, d1);
            Seller s4 = new Seller(4, "Juice WRLD", "juice@gmail.com", new DateTime(1995, 3, 31), 3000.00, d4);
            Seller s5 = new Seller(5, "Kenny G", "kennyG@gmail.com", new DateTime(1995, 9, 11), 4000.00, d3);
            Seller s6 = new Seller(6, "Matt", "matt@gmail.com", new DateTime(1995, 10, 27), 3000.00, d2);
